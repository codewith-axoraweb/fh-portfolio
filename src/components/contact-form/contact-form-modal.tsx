      ...
      <Transition show={showModal} as={Fragment}>
        ...
        >
          ...
          <div className="fixed inset-0 z-[9999] flex items-center justify-center">
            ...
            >
              <Dialog.Panel className="absolute m-4 w-[95%] max-w-xl overflow-y-auto rounded-2xl border-2 border-blue-600/20 bg-gradient-to-r from-blue-500 to-blue-800 px-6 py-8 shadow-lg shadow-accent/10 md:px-10 md:py-16">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-blue-600 bg-background p-2 text-sm text-blue-600 transition-transform hover:scale-[1.05] hover:bg-background"
                    onClick={() => setShowModal(false)}
                  >
                    <XIcon className="h-full w-full text-blue-600" />
                  </button>
                </div>
                <ContactForm
