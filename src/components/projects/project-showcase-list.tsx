    ...
    >
      ...
      <div className="flex flex-col gap-2">
        <Link href={props.data.href} className="relative max-w-max">
          ...
          <span className="hover:-underline-offset-1 text-3xl font-semibold text-blue-600 transition-colors duration-300 hover:underline sm:text-4xl md:text-5xl lg:hidden">
            {props.data.title}
          </span>
          <span
            className={classNames(
              "absolute -bottom-1 left-0 hidden h-1 origin-left rounded-lg bg-gradient-to-r from-blue-500 to-blue-800 transition-[width] duration-300 group-hover:w-full lg:block",
