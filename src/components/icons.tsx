...
export const FacebookIcon = (props: IconType) => (
  ...
  >
    <path d="M512 256C512 114.6 397.4 0 256 0S0 114.6 0 256c0 127.8 93.6 233.7 216 252.8V330h-65v-74h65v-56.4c0-64.1 38.1-99.6 96.9-99.6 28 0 57.3 5 57.3 5v63h-32.3c-31.8 0-41.7 19.7-41.7 39.9V256h71l-11.4 74h-59.6v178.8C418.4 489.7 512 383.8 512 256z" />
  </svg>
);
